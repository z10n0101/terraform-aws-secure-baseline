...
[![Github Actions](https://github.com/htec-infra/terraform-aws-secure-baseline/actions/workflows/main.yml/badge.svg)](https://github.com/htec-infra/terraform-aws-secure-baseline/actions/workflows/main.yml)
[![Releases](https://img.shields.io/github/v/release/htec-infra/terraform-aws-secure-baseline)](https://github.com/htec-infra/terraform-aws-secure-baseline/releases/latest)

[Terraform Module Registry](https://registry.terraform.io/modules/htec-infra/secure-baseline/aws)
...
## Credits
Source repository: https://github.com/nozaq/terraform-aws-secure-baseline
...
module "secure_baseline" {
  source = "htec-infra/secure-baseline/aws"
...
| <a name="input_account_type"></a> [account\_type](#input\_account\_type) | The type of the AWS account. The possible values are `individual`, `master`, `delegated_admin`, `member` . Specify `master` and `member` to set up centalized logging for multiple accounts in AWS Organization. Use individual` otherwise.` | `string` | no |
...
| <a name="input_delegated_admin_account_id"></a> [delegated\_admin\_account\_id](#input\_delegated\_admin\_account\_id) | The ID of the dedicated security AWS account associated to manage all security-related AWS services | `string` | no |
...
| <a name="input_ebs_baseline_enabled"></a> [ebs\_baseline\_enabled](#input\_ebs\_baseline\_enabled) | Boolean whether ebs-baseline is enabled. | `bool` | no |
